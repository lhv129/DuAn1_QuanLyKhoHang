                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?php if (isset($_SESSION['createStaff']['full_name'])) {
                                        echo $_SESSION['createStaff']['full_name'];
                                    } ?>">
                                <?php if (isset($_SESSION['errors']['full_name'])): ?>
                                    <a style="color:red"><i style="margin-top:10px;margin-right:5px"
                                            class="fa fa-warning"></i><?= $_SESSION['errors']['full_name']; ?></a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?php if (isset($_SESSION['createStaff']['name'])) {
                                        echo $_SESSION['createStaff']['name'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?php if (isset($_SESSION['createStaff']['email'])) {
                                        echo $_SESSION['createStaff']['email'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" name="password" placeholder="Nhập password ở đây" 
                                value="<?php if (isset($_SESSION['createStaff']['password'])) {
                                        echo $_SESSION['createStaff']['password'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?php if (isset($_SESSION['createStaff']['password2'])) {
                                        echo $_SESSION['createStaff']['password2'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?php if (isset($_SESSION['createStaff']['phone_number'])) {
                                        echo $_SESSION['createStaff']['phone_number'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="<?php if (isset($_SESSION['createStaff']['address'])) {
                                        echo $_SESSION['createStaff']['address'];
                                    } ?>">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="role_id">
                                    <?php foreach ($roles as $arrayRole) {
                                        ?>
                                        <option value="<?= $arrayRole['id'] ?>">
                                            <?php echo $arrayRole['name'] ?>
                                        </option>
                                        <?php
                                    }
                                    ?>
