        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Tạo Đơn Xuất Hàng</h4>
                ...
                <form class="form-horizontal" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 control-label col-form-label">Nhân viên</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 control-label col-form-label">Tên khách hàng</label>
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="customer" placeholder="Nhập tên khách hàng ở đây">
                            </div>
                        </div>
                        <div class="form-group row">
