...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card-check-details">
                ...
                <div class="list-add">
                    <table>
                        ...
                        <?php
                        $total_price = 0;
                        foreach ($deliveryDetails as $arrayDeliveryDetails) {
                            $stt = 0;
                            ?>
                            <tr>
                                <td><?= $arrayDeliveryDetails['product_name'] ?></td>
                                <td><?= $arrayDeliveryDetails['quantity'] ?></td>
                                <td><?= number_format($arrayDeliveryDetails['retail_price']); ?>đ</td>
                                <td><?= $arrayDeliveryDetails['unit_name'] ?></td>
                                <td>
                                    <?=number_format($arrayDeliveryDetails['sub_total']);
                                    $total_price += $arrayDeliveryDetails['sub_total'];?>đ
                                </td>
                        <?php
                        }
                        ?>
            ...
            <button class="btn btn-primary print-delivery">Print</button>
        </div>


        <div id="page-detail-delivery" class="container-fluid display-none">
            <div class="row">
                <div class="box-logo"><img class="logo" src="uploads/products/logo.png"></div>
                <div class="box-text">
                    <h3>HV Shop - Những gì bạn cần thì chúng tôi có</h3>
