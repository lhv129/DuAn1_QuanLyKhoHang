        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Chỉnh sửa phương thức thanh toán</h4>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    placeholder="Nhập tên phương thức thanh toán" value="<?php if (isset($_SESSION['editPayment']['name'])) {
                                        echo $_SESSION['editPayment']['name'];
                                    } else {
                                        echo $getOne['name'];
                                    } ?>">
