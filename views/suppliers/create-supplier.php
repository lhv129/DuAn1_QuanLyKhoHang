                ...
                <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Tên nhà cung
                                cấp</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    placeholder="Nhập tên sản phẩm ở đây" value="<?php if (isset($_SESSION['createSupplier']['name'])) {
                                        echo $_SESSION['createSupplier']['name'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="email" placeholder="Nhập email ở đây"
                                    value="<?php if (isset($_SESSION['createSupplier']['email'])) {
                                        echo $_SESSION['createSupplier']['email'];
                                    }?>">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 text-right control-label col-form-label">Số điện
                                thoại</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="phone_number"
                                    placeholder="Nhập số điện thoại ở đây" value="<?php if (isset($_SESSION['createSupplier']['phone_number'])) {
                                        echo $_SESSION['createSupplier']['phone_number'];
                                    } ?>">
