                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    placeholder="Nhập tên sản phẩm ở đây" value="<?php if (isset($_SESSION['editSupplier']['name'])) {
                                        echo $_SESSION['editSupplier']['name'];
                                    } else {
                                        echo $getOne['name'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="email" placeholder="Nhập email ở đây"
                                    value="<?php if (isset($_SESSION['editSupplier']['email'])) {
                                        echo $_SESSION['editSupplier']['email'];
                                    } else {
                                        echo $getOne['email'];
                                    } ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="phone_number"
                                    placeholder="Nhập số điện thoại ở đây" value="<?php if (isset($_SESSION['editSupplier']['phone_number'])) {
                                        echo $_SESSION['editSupplier']['phone_number'];
                                    } else {
