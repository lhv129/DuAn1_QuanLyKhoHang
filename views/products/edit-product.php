                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="brand_id">
                                    <?php foreach ($brands as $arrayBrand) {
                                        ?>
                                        <option value="<?= $arrayBrand['id'] ?>" <?php if ($getOne['brand_id'] === $arrayBrand['id']) {
                                              echo "selected";
                                          } ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    placeholder="Nhập tên sản phẩm ở đây" value="<?php
                                    if (isset($_SESSION['editProduct']['name'])) {
                                        echo $_SESSION['editProduct']['name'];
                                    } else {
                                        echo $getOne['name'];
                                    }
                                    ?>">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="unit_id">
                                    <?php foreach ($units as $arrayUnit) {
                                        ?>
                                        <option value="<?php echo $arrayUnit['id'] ?>" <?php if ($getOne['unit_id'] === $arrayUnit['id']) {
                                               echo "selected";
                                           } ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="entry_price"
                                    placeholder="Nhập giá nhập ở đây" value="<?php
                                    if (isset($_SESSION['editProduct']['entry_price'])) {
                                        echo $_SESSION['editProduct']['entry_price'];
                                    } else {
                                        echo $getOne['entry_price'];
                                    }
                                    ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="retail_price"
                                    placeholder="Nhập giá bán ở đây" value="<?php
                                    if (isset($_SESSION['editProduct']['retail_price'])) {
                                        echo $_SESSION['editProduct']['retail_price'];
                                    } else {
                                        echo $getOne['retail_price'];
                                    }
                                    ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                if (isset($_SESSION['editProduct']['slug'])) {
                                    echo $_SESSION['editProduct']['slug'];
                                } else {
                                    echo $getOne['slug'];
                                }
                                ?>">
