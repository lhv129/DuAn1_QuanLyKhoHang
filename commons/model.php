...
function unsetSession()
{
    ...
    unset($_SESSION['createSupplier']);
    unset($_SESSION['editSupplier']);
    unset($_SESSION['createUnit']);
    unset($_SESSION['editUnit']);
    unset($_SESSION['createBrand']);
    unset($_SESSION['editBrand']);
    unset($_SESSION['getOne']);
    unset($_SESSION['checkProductInWarehouse']);
    unset($_SESSION['createStaff']);
    unset($_SESSION['editStaff']);
    unset($_SESSION['createPayment']);
    unset($_SESSION['editPayment']);
}